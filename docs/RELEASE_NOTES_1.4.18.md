<p align="center">
  <img src="https://github.com/noambrand/kivun-terminal-wsl/releases/download/v1.4.18/Kivun_Terminal_v1.4.13.gif" width="700" alt="Kivun Terminal demo — Hebrew RTL Claude Code session">
</p>
...
> 📹 Prefer to watch first? **[Play the demo video (MP4)](https://github.com/noambrand/kivun-terminal-wsl/releases/download/v1.4.18/Kivun_Terminal_v1.4.13.mp4)**
...
## 🐧 Linux
Download `kivun-terminal-linux-1.4.18.tar.gz` below, extract, and run `./install.sh`.
...
Fixes first‑time setup on PCs that didn’t already have WSL:
- **No more install‑and‑reboot loop.** After WSL was installed and you rebooted, the installer could fail to notice WSL was now present and try to install it again — over and over. It now detects the freshly‑installed WSL correctly and continues straight to setting up Ubuntu and Claude. (Builds on the v1.4.17 fix that made the WSL install start in the first place.)
